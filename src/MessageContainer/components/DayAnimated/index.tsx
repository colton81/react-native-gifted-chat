...
const DayAnimated = ({ scrolledY, daysPositions, listHeight, renderDay, messages, isLoadingEarlier, offset, ...rest }: DayAnimatedProps) => {
	...
	const dayTopOffset = useMemo(() => offset?.top ?? 10, [offset])
	const dayBottomMargin = useMemo(() => offset?.bottom ?? 10, [offset])
