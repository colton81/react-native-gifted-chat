...
function MessageContainer(props) {
    ...
    return (<View style={[
      ...
      <AnimatedFlashList ref={forwardRef} data={messages} extraData={extraData} renderItem={renderItem} keyExtractor={keyExtractor} automaticallyAdjustContentInsets={true} contentInset={{ top: insets.top, bottom: insets.bottom }} contentInsetAdjustmentBehavior={"automatic"} {...invertibleScrollViewProps} ListEmptyComponent={renderChatEmpty} ListFooterComponent={ListFooterComponent} ListHeaderComponent={ListHeaderComponent} onScroll={scrollHandler} scrollEventThrottle={1} onEndReached={onEndReached} onEndReachedThreshold={0.1} {...listViewProps} onLayout={onLayoutList} 
