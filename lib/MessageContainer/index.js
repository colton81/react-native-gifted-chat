...
function MessageContainer(props) {
    ...
    return (<View style={[
      ...
      <DayAnimated scrolledY={scrolledY} daysPositions={daysPositions} listHeight={listHeight} renderDay={renderFloatingDay} messages={messages} isLoadingEarlier={isLoadingEarlier}/>
    </View>);
}
