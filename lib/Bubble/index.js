    ...
    const renderTicks = useCallback(() => {
        ...
        if (currentMessage &&
            ...
            return (<View style={styles.content.tickView}>
					{!!currentMessage.sent && (<Text style={[styles.content.tick, props.tickStyle]}>{"✓"}</Text>)}
					{!!currentMessage.received && (<Text style={[styles.content.tick, props.tickStyle]}>{"✓"}</Text>)}
					{!!currentMessage.pending && (<Text style={[styles.content.tick, props.tickStyle]}>{"🕓"}</Text>)}
				</View>);
        }
        return null;
    }, [props, currentMessage]);
